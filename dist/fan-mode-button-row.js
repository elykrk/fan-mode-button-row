...
class CustomFanModeRow extends LitElement {
	...
	hassChanged(hass) {
		...
		if (custTheme) {
			...
			if (mode1 == 'on') {
				mode1color = 'background-color: var(--ha-switch-checked-background-color)';
			} else {
				mode1color = 'background-color: var(--ha-card-background, var(--card-background-color))';
			}
			if (mode2 == 'on') {
				mode2color = 'background-color: var(--ha-switch-checked-background-color)';
			} else {
				mode2color = 'background-color: var(--ha-card-background, var(--card-background-color))';
			}
			if (mode3 == 'on') {
				mode3color = 'background-color: var(--ha-switch-checked-background-color)';
			} else {
